...
set_property PACKAGE_PIN V17 [get_ports {char_polynomial[0]}]					
           set_property IOSTANDARD LVCMOS33 [get_ports {char_polynomial}]
       set_property PACKAGE_PIN V16 [get_ports {char_polynomial[1]}]                    
          # set_property IOSTANDARD LVCMOS33 [get_ports {sw[1]}]
       set_property PACKAGE_PIN W16 [get_ports {char_polynomial[2]}]                    
           #set_property IOSTANDARD LVCMOS33 [get_ports {sw[2]}]
       set_property PACKAGE_PIN W17 [get_ports {char_polynomial[3]}]                    
